/**
 * Package tree context menu (UI component)
 *
 * Responsibilities:
 * - Show a custom context menu on right-click for package nodes in the project tree
...
/**
 * Initialize right-click context menu for package nodes.
 *
 ...
 */
export function initPackageTreeContextMenu(
  containerEl,
  {
    onCreatePackage,
    onCreateClass,
  ...
  if (!(containerEl instanceof HTMLElement)) {
    throw new TypeError("initPackageTreeContextMenu expects containerEl HTMLElement");
  }

  const menuEl = buildMenuEl();
  /** @type {PackageContext|null} */
  let currentCtx = null;
